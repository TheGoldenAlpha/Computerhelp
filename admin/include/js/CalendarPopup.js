...
function CalendarPopup() {
        ...
        c.setCloseText = CalendarPopup_setCloseText;
...
// Set the text to use for the close link
function CalendarPopup_setCloseText(text) {
        this.closeText = text;
        }
...
function CalendarPopup_select(inputobj, linkname, format, divname, YourDate) {
...
function CalendarPopup_getCalendar() {
        ...
        if (this.displayType=="date" || this.displayType=="week-end") {
                ...
                if (this.disabledWeekDays[current_weekday+1]) {
                        ...
                        dasatcalender = "&nbsp;<a  CLASS=\"text\" href=\"#\" onClick=\"document.getElementById('"+window.CalendarPopup_divname+"').style.visibility='hidden';\">"+this.closeText+"</a>\n";
